        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                let website = card
                    ...
                    project_brief: `Innovated Stop Watch with lap features, this project integrated with Start, Pause, Reset, Lap and Clear Lap
                    functionalities. By utilizing the clearInterval, set-time interval functions, ternary operation and applied innerHTML property,
                    i crafted start, pause, restart, lap buttons.`,

                    project_date: "2024",
                    project_client: "Persnol Project",
                    project_link: `www.${website}.com`,

                    image: [
                        "resources/img/portfolios/web/1.jpg",
                        "resources/img/portfolios/web/2.jpeg",
                        "resources/img/portfolios/web/3.webp",
                        "resources/img/portfolios/web/4.jpg",
                        "resources/img/web_design.jpeg",
                        "resources/img/web_design.jpeg",
                        "resources/img/web_design.jpeg",
                        "resources/img/web_design.jpeg",
                        "resources/img/web_design.jpeg",
                ...
                portfolioView({
                    namePlate: card.querySelector(".title").textContent,
                    category: "Music App",
                    project_brief: `Replicated Spotify music app for enhancing the user interface, I employed CSS key-frames and events
                    incorporate ’Click,TimeUpdate and Change’ Employing methods such as ’ParseInt, AddEventListener’. Both TimeUpdate and Change events are adopted to Sync range element and song duration, ParseInt method
                    determine the finished song duration .`,
                ...
                portfolioView({
                    ...
                    image: [
                        ...
                        "resources/img/portfolios/card/2.jpeg",
                        "resources/img/portfolios/card/3.jpeg",
